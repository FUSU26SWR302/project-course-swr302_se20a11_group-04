...
const TIERS = [
  { label: 'Bạc',       min: 500000,  color: '#a0aec0', code: 'FRES5',  discount: '5%' },
  { label: 'Vàng',      min: 1500000, color: '#d69e2e', code: 'FRES10', discount: '10%' },
  { label: 'Bạch Kim',  min: 3000000, color: '#805ad5', code: 'FRES15', discount: '15%' },
  { label: 'Kim Cương', min: 6000000, color: '#3182ce', code: 'FRES20', discount: '20%' },
];
